                ...
                <div className="flex flex-col space-y-6 p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="border border-gray-300/50 rounded-lg p-4 space-y-3">
                        ...
                        <div>
                          <p className="text-[#1a1c1e] font-medium mb-1 text-xs" style={{ fontFamily: 'var(--font-inter)' }}>ACCOMMODATION</p>
                          <p className="text-gray-500 text-xs" style={{ fontFamily: 'var(--font-inter)' }}>Room {room.roomNumber}</p>
                          <p className="text-gray-500 text-xs" style={{ fontFamily: 'var(--font-inter)' }}>Floor {room.floor}</p>
                        </div>
                      </div>
                      <div className="border border-gray-300/50 rounded-lg p-4 space-y-3">
                        <div className="w-6 h-6 text-gray-500">
                        ...
                        <div>
                          <p className="text-[#1a1c1e] font-medium mb-1 text-xs" style={{ fontFamily: 'var(--font-inter)' }}>CAPACITY</p>
                          <p className="text-gray-500 text-xs" style={{ fontFamily: 'var(--font-inter)' }}>Up to {room.roomType?.maxGuests || 2} guests</p>
                          <p className="text-gray-500 text-xs" style={{ fontFamily: 'var(--font-inter)' }}>UGX {room.roomType?.basePrice?.toLocaleString()}/night</p>
                        </div>
                      </div>
                    </div>
                  </div>
